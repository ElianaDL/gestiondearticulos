...
export default function ArticulosRegistro({AccionABMC, ArticulosFamilias, Item,
  Grabar, Volver}) {
          ...
          <div className="row">
            ...
            <input
              ...
              {...register("Nombre", {
                minLength: {
                 value: 1,
                 message: 'El campo debe tener al menos 1 caracter' 
                },
              })}
              autoFocus
          ...
          <div className="row">
            ...
            <div className="col-sm-8 col-md-6">
              <select
                ...
                className="form-control"
              >
                {/*<option value="" key={1}></option>  <--- Buscar que hace esto RTA: Estaba
                harcodeando el value y el key para obtener uno especifico*/}
